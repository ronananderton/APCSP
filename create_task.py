...
die_2_rolls = ["Double Points" , "Gain A Roll" , "Lose Half Points" , "Lose All Points" ]
r = 5
    ...
    while r > 0 and total_points >= 0 and total_points < 1000:
        ...
        if die_choice == "1":
            ...
            if r2 == "Double Points":
                ...
                total_points /= 2
                print("You lost half of your points.")
...
points, gaining a roll, losing half of your points, or losing all of your points. Your goal is to obtain 1,000 points. ''')

ending_points = run_dice_game(r)
print()
if ending_points >= 1000:
    print("You Win!")
